...
\todo[inline]{Разбить на научные статьи и другое}
\todo[inline]{Нежно отсиртировать}
...
\todo[inline]{Добавить ссылку на работу Андрея Шадрикова}
\todo[inline]{http://www.machinelearning.ru/wiki/index.php?title=BigARTM и ссылки отсюда}

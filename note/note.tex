...
\todo[inline]{Заменить эту страницу на подписанное ТЗ}

\chapter{Календарный план}
...
\include{sections/analytical_section}   % аналитический раздел;
\include{sections/engineering_section}  % конструкторский раздел;
\include{sections/technological_section}% технологический раздел;
\include{sections/experimental_section} % экспериментальный раздел;
\include{sections/conclusion}           % заключение;
\include{sections/bibliography}         % список литературы;
\include{sections/applications}         % приложения.
